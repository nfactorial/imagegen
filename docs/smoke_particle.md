...
![Smoke Particle Example](images/smoke_example1)
...
![Circle Example](images/smoke_particle_3.png)
...
![Circle Noise Example](images/smoke_particle_4.png)
...
![Final Smoke Example](images/smoke_particle_5.png)
More complicated images can be constructed by playing with the various settings or attaching parameters to other
nodes. If you have followed this tutorial all the way through you should end up with a JSON file that looks like
the following:
```
{
    "nodes": [
